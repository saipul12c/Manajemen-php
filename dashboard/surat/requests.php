                                ...
                                <div class="flex items-center justify-end gap-1.5">
                                    <?php if ($r['status'] === 'selesai'): ?>
                                        <a href="request_print.php?id=<?= $r['id'] ?>" target="_blank" 
                                           class="rounded-xl border border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 px-3 py-1.5 text-xs font-bold text-emerald-300 transition inline-flex items-center gap-1.5">
                                    ...
                                    <?php if ($is_staff): ?>
                                        <?php if ($r['status'] !== 'diproses'): ?>
                                            <form method="POST" class="inline">
                                                ...
                                                <button type="submit" class="rounded-xl border border-blue-500/30 bg-blue-500/10 px-2.5 py-1.5 text-xs font-medium text-blue-300 hover:bg-blue-500/20 transition cursor-pointer">
                                                    Proses
                                                </button>
                                            </form>
                                        <?php endif; ?>
                                        <?php if ($r['status'] !== 'selesai'): ?>
                                            <form method="POST" class="inline">
                                                ...
                                                <button type="submit" class="rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-1.5 text-xs font-medium text-emerald-300 hover:bg-emerald-500/20 transition cursor-pointer">
                                                    Setujui
                                                </button>
                                            </form>
                                        <?php endif; ?>
                                        <?php if ($r['status'] !== 'ditolak'): ?>
                                            <form method="POST" class="inline">
                                                ...
                                                <button type="submit" class="rounded-xl border border-rose-500/30 bg-rose-500/10 px-2.5 py-1.5 text-xs font-medium text-rose-300 hover:bg-rose-500/20 transition cursor-pointer">
                                                    Tolak
                                                </button>
                                            </form>
                                        <?php endif; ?>
